...
\begin{table}[!h]%[tbp]
	...
	\begin{tabular}{| c | c | c | c | c | c | c |}
		\hline
		~				& Unprocessed		& Feature					& C				& Gamma ($\gamma$)	& Kernel	& Row count	 	\\ \hline
...
% training_data_10000_unprocessed_sgd
% Best parameters: {'vect__max_df': 0.5, 'vect__min_df': 0.01, 'clf__alpha': 1e-05, 'clf__n_iter': 50, 'tfidf__norm': 'l2', 
% 'clf__loss': 'log', 'tfidf__use_idf': False, 'clf__penalty': 'elasticnet'}
...
\begin{table}[!h]%[tbp]
	...
	\begin{tabular}{| c| c | c | c | c |}
		...
		Alpha 			& xxxxx				& 1e$^{-05}$ (0.00001)		& 1e$^{-05}$ (0.00001)		\\ \hline
