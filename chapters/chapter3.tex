...
At first there questions were cleaned of their HTML content, but later on I realised that this would cause issues when detecting code samples and links. 
