...
\todo[inline]{For simon;  forgot to mention this section is not written, it mainly contained copy/pasted of notes from report. I'm now reading through the books to attempt to write in the relevant}

% rewrite all these; notes from AI/ML books
...
\gls{svm}s are good for solving regression and classification problems.
